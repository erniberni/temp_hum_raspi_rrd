...
// ATTiny84 operated @8MHz - Fuses: lfuse, hfuse, efuse: E2, D7, FF
// New feature: send information on uptime (minutes since boot) by Reinhard Nickels
...
#define ACK_TIME 50       // Number of milliseconds to wait for an ack  -> made this longer !

#define DHT22_PIN 10     // DHT sensor is connected on D10/ATtiny pin 10
#define DHT22_POWER 9 // DHT Power pin is connected on D9/ATtiny pin 9
 ...
 typedef struct {
  	  ...
  	  int supplyV;	// Supply voltage
   	  int temp;	// Temperature reading
          unsigned long boots;    // minutes since boot, overflow after 49 days
 } Payload;
...
void loop() {
  ...
  Sleepy::loseSomeTime(54000); //JeeLabs power save function: enter low power mode for 60 seconds (valid range 16-65000 ms)
  // 60.000 = 76s 
}
